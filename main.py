...
class GIFMaker(tk.Tk):
    ...
    def __init__(self):
        ...
        self.canvas = tk.Canvas(self, width=640 , height=480, background='#D6D6D6')
        ...
        self.export_button = tk.Button(self , text='EXPORT', command = self.export_gif)
        self.export_button.pack(pady=20)

        self.progress = ttk.Progressbar(self , orient = tk.HORIZONTAL , length=50 , mode='indeterminate')
    ...
    def animate_preview(self):
        ...
        frame_image = frame_image.resize((640,480) , PIL.Image.LANCZOS)
    ...
    def create_gif(self , fps , scale):
        ...
        messagebox.showinfo("Success" , "JOB HAS BEEN DONE!")
